...
namespace PBDFluid
{
    ...
    public class CSPHFluidSolver : FluidSolver {

        public CSPHFluidSolver(FluidBody body, FluidBoundary boundary) : base(body, boundary) {
            m_shader = Resources.Load("ComputeShaders/CSPHSolver") as ComputeShader;
        }
        ...
        public override void StepPhysics(float dt)
        {
            ...
            m_shader.SetFloat("GasConstant", 2000f);
            m_shader.SetFloat("RestDensity", Body.Density / 2f); // CSPH
